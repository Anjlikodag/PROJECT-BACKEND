...
const {isValid,isValidString,isValidObject,isValidEmail,SALT,
} = require("../utils");
...
const updateUser = async (req, res) => {
  ...
  try {
    ...
    const updatedUser = await UserModel.findByIdAndUpdate(userId, { $set: userData }, { new: true });  // findByIdAndUpdate is take three parameter('where to update', 'updated data', 'if you want to show updated data( make true)')
